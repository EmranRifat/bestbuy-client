...
const Headber = () => {
  return (
    <div className=" py-1 hidden 		    lg:flex justify-center -mx-3 font-semibold text-sm overflow-y-auto whitespace-nowrap scroll-hidden bg-gradient-to-r from-emerald-500 to-lime-500 mb-4 md:mb-0 text-white-500 space-x-12 ">
      <Link
